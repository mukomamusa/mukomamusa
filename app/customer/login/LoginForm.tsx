...
function LoginFormContent() {
  ...
  const handleGoogleLogin = async () => {
    window.location.href = '/api/auth/google?user_type=customer';
  };
      ...
      <div style={{ maxWidth: '28rem', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
            {isLogin ? 'Welcome back! Login to book your tickets' : 'Create an account to start booking'}
          </p>
        </div>
        ...
        {isLogin && !showForgotPassword && !requires2FA && (
          <div style={{
            ...
            <p style={{ fontSize: '0.875rem', color: '#374151' }}>Email: customer@example.com</p>
